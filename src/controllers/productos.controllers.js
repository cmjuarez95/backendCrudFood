...
export const borrarProductoPorId = async (req, res)=>{
    try {
        ...
        console.error(error)
        res.status(500).json({mensaje:"Ocurrio un error al borrar el producto", error: error.message,})
...
export const editarProductoPorId = async (req, res)=>{
    try {
        ...
        console.error(error)
        res.status(500).json({mensaje:"Ocurrio un error al editar el producto", error: error.message,})
